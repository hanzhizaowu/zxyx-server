package cn.zhaoxi.zxyx.util.client;

import cn.zhaoxi.zxyx.service.mqtt.MqttRestService;
import cn.zhaoxi.zxyx.util.JsonUtils;
import cn.zhaoxi.zxyx.util.ParamUtil;
import cn.zhaoxi.zxyx.util.config.MqttClientConfig;
...
public class MyMqttClient {
    ...
    public MqttClient getClient() {
        ...
        try {
            ...
            mqttClient = new MqttClient(clientConfig.getBrokerUrl(), ParamUtil.getUUID());
            //设置client回调
    ...
    public void publish(String topic, Object obj) {
        ...
        try {
            ...
            log.info("mqttclient is:" + mqttClient.toString());
            log.info("topic is:" + topic + " ,message is:" + message);
